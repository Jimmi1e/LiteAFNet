...
if __name__ == "__main__":
    ...
    """ Training logfile """
    train_log_path = "files/train_att3car.txt"
    if os.path.exists(train_log_path):
        print("Log file exists")
    else:
        train_log = open("files/train_att3car.txt", "w")
        train_log.write("\n")
        train_log.close()
    ...
    num_epochs = 50
    lr = 1e-3
    checkpoint_path = "files/checkpoint_att3layercar.pth"

    """ Dataset """
    path = "/kaggle/working/VOCdevkit"
